                        ...
                        SchedulePlan.prototype.openModal = function (event) {
                            ...
                            if (
                                ...
                                this.modalBody
                                    ...
                                    .val(event.find(".event-quantity-ktv").html() + " Cas");
                                event.find(".event-quantity-ktv").text() != ""
                                    ? this.modalBody
                                          .find(".order-quantity-ktv")
                                ...
                                this.modalBody
                                    .find(".order-note-ktv")
                                    .val(event.find(".event-note-ktv").html());
                                this.modalBody
                                    .find(".order-quantity-ktv")
                                    .attr("disabled", true);
                                this.modalBody.find(".order-note-ktv").attr("disabled", true);
                                this.modalBody
                                ...
                                this.modalBody
                                    ...
                                    .removeClass("form-textbox-entered")
                                    .val("");
                                this.modalBody.find(".order-note-ktv").val("");
                                this.modalBody
                                    .find(".order-quantity-ktv")
                                    .attr("disabled", false);
                                this.modalBody.find(".order-note-ktv").attr("disabled", false);
                                this.modalBody
                                    .find(".submit-quantity-technologist")
                                    .attr("disabled", false)
                                    .removeClass("hidden");
